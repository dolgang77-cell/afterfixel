...
function ClubThumb({ id = 'c1', tint = 'magenta', size = 200, ratio = 1, fill = false, style = {} }) {
  // LIGHTWEIGHT: replaced 50+ SVG nodes per thumb with a layered CSS render
  // (3 div layers: sky gradient, spotlight cone, crowd silhouette).
  // ~5 DOM nodes total instead of 50+.
  ...
  return (
    <div style={{
      ...
      {/* Crowd silhouette — single SVG path, ~1 node */}
      <svg
        viewBox="0 0 100 30"
